...
No child slice has shipped under this packet. For each completed child, record
its issue, PR/commit, targeted tests, installed/runtime proof where applicable,
clean-machine or demo evidence, remaining limitations, and alignment with
`requirements.md` and `design.md`. Do not mark a slice complete from this stub.
